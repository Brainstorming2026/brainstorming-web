...
// Resend que apps/web (free tier: 1 dominio, compartido entre ambos sitios).
export const EMAIL_FROM = CORREO_FROM

// Bandeja interna del equipo — recibe la notificacion de cada lead nuevo.
// El `replyTo` de esa notificacion se setea al email del lead en la ruta,
// para que el equipo responda con un click.
