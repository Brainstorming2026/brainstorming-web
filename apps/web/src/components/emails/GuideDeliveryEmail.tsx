...
export function GuideDeliveryEmail({ firstName, guideTitle, guideUrl }: GuideDeliveryEmailProps) {
  return (
    <EmailLayout preview={`Tu guía "${guideTitle}" ya está lista para descargar`}>
      ...
      <Section style={{ backgroundColor: emailColors.mist, borderRadius: '14px', padding: '20px 24px', margin: '0 0 28px' }}>
