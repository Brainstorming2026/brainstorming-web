...
// Remitente de todos los correos salientes. Mismo dominio verificado en
// Resend que apps/web y apps/us (free tier: 1 dominio compartido entre las 3).
export const EMAIL_FROM = CORREO_FROM

// Bandeja interna del equipo — recibe la notificacion de cada suscriptor y
// cada descarga de guia. El `replyTo` de esa notificacion se setea al email
// del lead cuando aplica, para que el equipo responda con un click.
